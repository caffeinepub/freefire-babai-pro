...
function multiplierToPoint(m, crashPoint) {
  const raw = Math.min((m - 1) / (crashPoint - 1 + 1e-3), 1);
  const tX = raw;
  const tY = raw ** 0.55;
  return {
...
function PlaneIcon({
  ...
  const glowColor = color === "safe" ? "oklch(0.75 0.22 150)" : color === "warning" ? "oklch(0.78 0.18 75)" : "oklch(0.60 0.25 25)";
...
function HistoryPill({ value, isNew }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `pill ${colorMap[color]} ${isNew ? "pill-new" : ""}`, children: formatMultiplier(value) });
}
function AxisLabels({ crashPoint }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    labels.map(({ v, y }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "text",
      {
        x: ORIGIN_X - 4,
        y: y + 4,
    ...
    labels.map(({ v, y }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "line",
      {
        x1: ORIGIN_X,
        y1: y,
...
function App() {
  ...
  const [cashOutValue, setCashOutValue] = reactExports.useState(null);
  ...
  const [betAmount, setBetAmount] = reactExports.useState("100");
  const [curvePoints, setCurvePoints] = reactExports.useState([]);
  const [planeAngle, setPlaneAngle] = reactExports.useState(-45);
  const [tipPoint, setTipPoint] = reactExports.useState({ x: ORIGIN_X, y: ORIGIN_Y });
  const [shaking, setShaking] = reactExports.useState(false);
  const [showCrashFlash, setShowCrashFlash] = reactExports.useState(false);
  const [showCashoutFlash, setShowCashoutFlash] = reactExports.useState(false);
  const [newestHistoryIndex, setNewestHistoryIndex] = reactExports.useState(-1);
  const intervalRef = reactExports.useRef(null);
  const crashPointRef = reactExports.useRef(3);
  const multiplierRef = reactExports.useRef(1);
  const prevTipRef = reactExports.useRef({ x: ORIGIN_X, y: ORIGIN_Y });
  const historyScrollRef = reactExports.useRef(null);
  ...
  const scrollHistoryToStart = reactExports.useCallback(() => {
    requestAnimationFrame(() => {
      var _a2;
      (_a2 = historyScrollRef.current) == null ? void 0 : _a2.scrollTo({ left: 0, behavior: "smooth" });
    });
  }, []);
  ...
  const startGame = reactExports.useCallback(() => {
    ...
    intervalRef.current = setInterval(() => {
      ...
      if (current >= cp2) {
        ...
        setTimeout(() => setShowCrashFlash(false), 1e3);
        setTimeout(() => setNewestHistoryIndex(-1), 600);
      }
    }, 100);
  }, [gameState, stopInterval, scrollHistoryToStart]);
  const cashOut = reactExports.useCallback(() => {
    if (gameState !== "running") return;
    stopInterval();
    const current = multiplierRef.current;
    const bet2 = Number.parseFloat(betAmount) || 0;
    const win = Number.parseFloat((bet2 * current).toFixed(2));
    setCashOutValue(win);
  ...
  const strokeColor = color === "safe" ? "oklch(0.75 0.22 150)" : color === "warning" ? "oklch(0.78 0.18 75)" : "oklch(0.60 0.25 25)";
  const fillColorStop = color === "safe" ? "oklch(0.75 0.22 150 / 0.18)" : color === "warning" ? "oklch(0.78 0.18 75 / 0.18)" : "oklch(0.60 0.25 25 / 0.18)";
  const multiplierColorClass = {
    safe: "text-safe",
    warning: "text-warn",
    danger: "text-danger"
  };
  const multiplierGlowClass = {
    safe: "glow-safe",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      ref: gameAreaRef,
      children: [
        showCrashFlash && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        showCashoutFlash && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "av-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-brand", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "av-brand-icon", role: "img", "aria-label": "plane", children: "✈️" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "av-brand-name", children: "AVIATOR" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "av-badge", children: "DEMO" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-status", children: [
            gameState === "running" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-live", children: "⬤ LIVE" }),
            gameState === "crashed" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-crashed", children: "⬤ CRASHED" }),
            gameState === "cashout" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-won", children: "⬤ WON" }),
            gameState === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-idle", children: "⬤ WAITING" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-history-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ref: historyScrollRef,
            className: "av-history-scroll history-scroll",
            "data-ocid": "history.list",
            children: history.map((val, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              HistoryPill,
              {
                value: val,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-canvas", "data-ocid": "game.canvas_target", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-vignette" }),
            ...
            "svg",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "curveGrad", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: strokeColor, stopOpacity: "0.3" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: strokeColor, stopOpacity: "1" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "areaGrad", x1: "0%", y1: "0%", x2: "0%", y2: "100%", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: fillColorStop }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.10 0.02 255 / 0)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("filter", { id: "curveGlow", x: "-10%", y: "-40%", width: "120%", height: "180%", children: [
                ...
                (gameState === "running" || gameState === "crashed" || gameState === "cashout") && /* @__PURE__ */ jsxRuntimeExports.jsx(AxisLabels, { crashPoint }),
                curvePoints.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "path",
                  {
                ...
                gameState === "running" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "circle",
                  {
                    cx: tipPoint.x,
                    cy: tipPoint.y,
          ...
          (gameState === "running" || gameState === "crashed") && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "av-plane",
              style: {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  color,
                  animClass: gameState === "crashed" ? "plane-crash" : "plane-float",
                  angle: gameState === "crashed" ? 30 : planeAngle
                }
              )
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-multiplier-area", children: [
            gameState === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "waiting-pulse av-idle-msg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-idle-title", children: "PLACE YOUR BET" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-idle-sub", children: "Press FLY to launch" })
            ] }),
            gameState === "running" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-live-mult", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `av-mult-value ${multiplierColorClass[color]} ${multiplierGlowClass[color]}`,
                  "data-ocid": "game.multiplier_display",
                  children: formatMultiplier(multiplier)
                }
              ),
              bet > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-win-preview", children: [
                "₹",
                potentialWin.toFixed(2)
              ] })
            ] }),
            gameState === "crashed" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-crash-msg", "data-ocid": "game.crashed_display", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-crash-label", children: "FLEW AWAY" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-crash-value", children: formatMultiplier(multiplier) })
            ] }),
            gameState === "cashout" && cashOutValue !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "av-cashout-msg win-bounce",
                "data-ocid": "game.cashout_display",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-cashout-label", children: "CASHED OUT" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-cashout-value", children: formatCurrency(cashOutValue) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-cashout-at", children: [
                    "at ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-controls", "data-ocid": "controls.panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-bet-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-bet-label", children: "BET AMOUNT" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-bet-input-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-input-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "av-currency", children: "₹" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "av-quick-bets", children: ["50", "200", "500"].map((amt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
            ...
            gameState === "running" && bet > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-pot-win", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "av-pot-label", children: "POTENTIAL WIN" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `av-pot-value ${multiplierColorClass[color]}`, children: formatCurrency(potentialWin) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "av-actions", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: gameState === "idle" ? "🚀 FLY!" : gameState === "running" ? "FLYING..." : "🚀 FLY AGAIN"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: gameState === "running" ? `💰 CASH OUT · ${formatMultiplier(multiplier)}` : "CASH OUT"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "av-footer", children: [
          "© ",
